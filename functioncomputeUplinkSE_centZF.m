function SE = functioncomputeUplinkSE_centZF(H_hat,R_tilde,tau_c,tau_p,numRealz,K,L,N,allocatedPowUEs)
%This function computes achievable SE of a radio stripes network with
%centralized ZF receiver
%
...
%with centralized ZF prcoessing
...
for iRealz = 1:numRealz
    ...
    %V = (Hhat'*Hhat)\Hhat'; %ZF
    V = pinv(Hhat); % ZF centralized receiver matrix
